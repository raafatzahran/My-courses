package com.rfz.app.ws.utils;

import com.rfz.app.ws.exceptions.MissingRequiredFieldException;
    ...
    public void validateRequiredFields(UserDTO userDto) throws MissingRequiredFieldException {
        if (userDto.getFirstName() == null
            ...
            throw new MissingRequiredFieldException(
                    ErrorMessages.MISSING_REQUIRED_FIELD.getErrorMessage() + ". Requested object= " + userDto.toString());
        }
